...
public interface DBOperation {
	...
	public static final String GET_EMPLOYEE_ID_NAME_DETAILS="SELECT EMP_ID,EMP_NAME FROM EMPLOYEE_JDBC ";
	public static final String GET_EMPLOYEE_JOB_EMPLOYEE_SALARY_Details="SELECT  EMP_JOB,EMP_SALARY FROM EMPLOYEE_JDBC";
	public static final String GET_EMPLOYEE_ID_SALARY_DETAILS ="SELECT EMP_ID,EMP_SALARY FROM EMPLOYEE_JDBC";
	public static final String GET_EMPLOYEE_ID_JOB_SALARY_DETAILS ="SELECT EMP_ID,EMP_JOB,EMP_SALARY FROM EMPLOYEE_JDBC";
